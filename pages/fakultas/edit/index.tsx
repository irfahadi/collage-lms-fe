            ...
            <Grid container spacing={2}>
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  helperText={
                    formik.touched.nama_fakultas && formik.errors.nama_fakultas
                  }
                  error={
                    formik.touched.nama_fakultas &&
                    Boolean(formik.errors.nama_fakultas)
                  }
                />
              </Grid>
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  name="kode_fakultas"
                  id="kode_fakultas"
                  value={formik.values.kode_fakultas}
                  onChange={formik.handleChange}
                  helperText={
                    formik.touched.kode_fakultas && formik.errors.kode_fakultas
                  }
                  error={
                    formik.touched.kode_fakultas &&
                    Boolean(formik.errors.kode_fakultas)
                  }
                />
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  name="nama_dekan"
                  id="nama_dekan"
                  value={formik.values.nama_dekan}
                  onChange={formik.handleChange}
                  helperText={
                    formik.touched.nama_dekan && formik.errors.nama_dekan
                  }
                  error={
                    formik.touched.nama_dekan &&
                    Boolean(formik.errors.nama_dekan)
                  }
                />
              </Grid>
              <Grid item xs={12} md={6}>
...
EditFakultas.getLayout = function getLayout(page: React.ReactNode) {
  const router = useRouter()
  return <MainLayout title="Edit Fakultas">{page}</MainLayout>
}
